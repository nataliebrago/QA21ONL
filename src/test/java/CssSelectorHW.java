...
public class CssSelectorHW {
    protected WebDriver driver;
        ...
        public void CssSelector() {
            ...
            // Поиск по id
            Assert.assertTrue(driver.findElement(By.cssSelector("#input_1493283059688")).isDisplayed());
            //   аналог
            Assert.assertTrue(driver.findElement(By.id("input_1493283059688")).isDisplayed());
